...
<html lang="en">
<head>
    <title>Char Dham – Explore India</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .section-heading span { color: #7eb8f7; }
        ...
        /* Custom 5-image Slider for Devbhoomi Uttarakhand */
        .fling-minislide-5 {
            width: 100%;
            height: 260px;
            overflow: hidden;
        ...
        .itinerary-list::-webkit-scrollbar-thumb { background: rgba(126,184,247,0.3); border-radius: 4px; }
        ...
        .book-btn:hover { background: #9ecaf9; transform: scale(1.04); color: #0a0a0a; }
...
<div class="video-hero">
    <video
        ...
        loop
        playsinline>
        <source src="https://res.cloudinary.com/dkf2ala8d/video/upload/v1781853031/vidssave.com_Uttarakhand_Tourism_-_Simply_Sensational_1080P_qz0i3k.mp4" type="video/mp4">
    </video>
    ...
    <div class="hero-content">
        ...
        <h1>Explore <span>Uttarakhand</span></h1>
        <p>Sacred Himalayan shrines, pristine rivers and breathtaking valleys — a divine journey through Devbhoomi.</p>
...
<div class="main-content" id="package">
    <div class="content-wrapper">
        <p class="section-label">Char Dham Package</p>
        <h2 class="section-heading">Your Sacred Journey <span>Awaits</span></h2>
        ...
        <div class="two-col">
            ...
            <div class="slider-box">
                <div class="fling-minislide-5">
                    <img src="images/CD1.jpg"  alt="Haridwar"/>
                    <img src="images/CD2.jpg"    alt="Badrinath"/>
                    <img src="images/CD3.jpg" alt="Rishikesh"/>
                    <img src="images/CD4.jpg" alt="Kedarnath"/>
                    <img src="images/CD5.jpg" alt="Tungnath"/>
                </div>
                <div class="slider-info">
                    <h3>Uttarakhand Highlights</h3>
                    <p>From the ghats of Haridwar to the snow-capped peaks of Badrinath, the Char Dham Yatra is India's most sacred pilgrimage through the lap of the Himalayas.</p>
                    <div class="highlights">
                        <span class="highlight-chip"><span class="fa fa-fire"></span> Haridwar</span>
                        <span class="highlight-chip"><span class="fa fa-star"></span> Badrinath</span>
                        <span class="highlight-chip"><span class="fa fa-tint"></span> Rishikesh</span>
                        <span class="highlight-chip"><span class="fa fa-mountain" style="font-style:normal;">⛰</span> Kedarnath</span>
                        <span class="highlight-chip"><span class="fa fa-sun-o"></span> Yamunotri</span>
                    </div>
                </div>
            </div>
            ...
            <div class="package-box">
                <div class="package-header">
                    ...
                    <p>Hotel stays included • All major dhams covered</p>
                </div>

                <div class="itinerary-list">
                <?php
                $sqlhotel = "SELECT * FROM package WHERE pa_name='Char Dham' LIMIT 1";
                ...
                <form action="predefine_book.php" method="post">
                    ...
                    <div class="package-footer">
                        <div class="price-block">
                            ...
                            <?php
                            $sql5  = "SELECT price FROM package WHERE pa_name='Char Dham' LIMIT 1";
...
<script>
(function () {
    var video = document.getElementById('charDhamVideo');
