...
<html lang="en">
<head>
    <title>Gujarat – Explore India</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-scroll-btn {
            ...
            border: 1px solid rgba(94,207,168,0.4);
            padding: 10px 22px;
            border-radius: 30px;
            cursor: pointer;
        ...
        .hero-scroll-btn:hover {
            background: rgba(94,207,168,0.28);
            border-color: rgba(94,207,168,0.65);
            color: #fff;
            text-decoration: none;
        }
        .scroll-hint {
        ...
        /* Custom 5-image Slider for Gujarat */
        .fling-minislide-5 {
            width: 100%;
            height: 260px;
            overflow: hidden;
        ...
        .itin-item:not(:last-child)::after {
            ...
            bottom: 0;
            width: 1px;
            background: rgba(94,207,168,0.15);
        }
        ...
        .itin-dot {
            ...
            height: 28px;
            border-radius: 50%;
            background: rgba(94,207,168,0.12);
            border: 1.5px solid rgba(94,207,168,0.35);
            color: #5ecfa8;
            font-size: 9.5px;
            font-weight: 700;
            display: flex;
        ...
        .book-btn:hover { background: #7edcb8; transform: scale(1.04); color: #0a0a0a; }
...
<div class="video-hero">
    <video
        ...
        loop
        playsinline>
        <source src="https://res.cloudinary.com/dkf2ala8d/video/upload/v1781715987/Explore_Gujarat_-_A_Complete_Journey_Through_Every_Corner_of_the_State_Gujarat_Tourism_itdfwo.mp4" type="video/mp4">
    </video>
    ...
    <div class="hero-content">
        ...
        <h1>Explore <span>Gujarat</span></h1>
        <p>Land of the White Desert, Asiatic lions, ancient temples and vibrant folk traditions.</p>
...
<div class="main-content" id="package">
    <div class="content-wrapper">
        <p class="section-label">Gujarat Package</p>
        ...
        <div class="two-col">
            ...
            <div class="slider-box">
                <div class="fling-minislide-5">
                    <img src="images/GUJ1.jpg"    alt="Girforest"/>
                    <img src="images/GUJ2.jpg" alt="RunnofKutch"/>
                    <img src="images/GUJ3.jpg"     alt="Somnath"/>
                    <img src="images/GUJ4.jpg"  alt="Dwarka"/>
                    <img src="images/GUJ5.jpg"  alt="Lothal"/>
                </div>
                <div class="slider-info">
                    <h3>Gujarat Highlights</h3>
                    <p>From the salt flats of Kutch to the forests of Gir, Gujarat offers an unforgettable journey through culture, wildlife and spirituality.</p>
                    <div class="highlights">
                        <span class="highlight-chip"><span class="fa fa-paw"></span> Gir Forest</span>
                        <span class="highlight-chip"><span class="fa fa-sun-o"></span> Rann of Kutch</span>
                        <span class="highlight-chip"><span class="fa fa-institution"></span> Somnath</span>
                        <span class="highlight-chip"><span class="fa fa-anchor"></span> Dwarka</span>
                        <span class="highlight-chip"><span class="fa fa-ship"></span> Lothal</span>
                    </div>
                </div>
            </div>
            ...
            <div class="package-box">
                ...
                <?php
                $sqlhotel = "SELECT * FROM package WHERE pa_name='Gujarat' LIMIT 1";
                ...
                <form action="predefine_book.php" method="post">
                    ...
                    <div class="package-footer">
                        <div class="price-block">
                            ...
                            <?php
                            $sql5  = "SELECT price FROM package WHERE pa_name='Gujarat' LIMIT 1";
...
<script>
(function () {
    var video = document.getElementById('gujVideo');
