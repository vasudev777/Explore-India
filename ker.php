...
<html lang="en">
<head>
    <title>Kerala – Explore India</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-content h1 span { color: #4ecb8d; }
        .hero-content p {
        ...
        .hero-scroll-btn {
            ...
            font-weight: 600;
            color: #fff;
            background: rgba(78,203,141,0.18);
        ...
        .hero-scroll-btn:hover {
            background: rgba(78,203,141,0.28);
            border-color: rgba(78,203,141,0.65);
            color: #fff;
            text-decoration: none;
        }
        .scroll-hint {
        ...
        .section-heading span { color: #4ecb8d; }
        ...
        /* Custom 5-image Slider for God's Own Country Kerala */
        .fling-minislide-5 {
            width: 100%;
            height: 260px;
            overflow: hidden;
        ...
        .highlight-chip {
            ...
            border: 1px solid rgba(78,203,141,0.22);
            padding: 5px 12px;
            border-radius: 20px;
        }
        ...
        .itinerary-list {
            ...
            scrollbar-color: rgba(78,203,141,0.3) transparent;
        }
        .itinerary-list::-webkit-scrollbar { width: 4px; }
        .itinerary-list::-webkit-scrollbar-track { background: transparent; }
        .itinerary-list::-webkit-scrollbar-thumb { background: rgba(78,203,141,0.3); border-radius: 4px; }
        ...
        .itin-dot {
            ...
            border: 1.5px solid rgba(78,203,141,0.35);
            color: #4ecb8d;
            font-size: 9.5px;
            font-weight: 700;
            display: flex;
        ...
        .book-btn:hover { background: #6ed9a0; transform: scale(1.04); color: #0a0a0a; }
...
<div class="video-hero">
    <video
        ...
        loop
        playsinline>
        <source src="https://res.cloudinary.com/dkf2ala8d/video/upload/v1781851518/The_Great_Backwaters_Kerala_-_World_s_Greatest_Place_-_Kerala_Tourism_1080p_h264_coqmkd.mp4" type="video/mp4">
    </video>
    ...
    <div class="hero-content">
        ...
        <h1>Explore <span>Kerala</span></h1>
        <p>Serene backwaters, misty hill stations, Ayurveda retreats and golden beaches of God's Own Country.</p>
...
<div class="main-content" id="package">
    <div class="content-wrapper">
        <p class="section-label">Kerala Package</p>
        ...
        <div class="two-col">
            ...
            <div class="slider-box">
                <div class="fling-minislide-5">
                    <img src="images/KER1.jpg"               alt="Alleppey"/>
                    <img src="images/KER2.jpg"              alt="Munnar"/>
                    <img src="images/KER3.jpg"  alt="Kovalam"/>
                    <img src="images/KER4.jpg"             alt="Wayanad"/>
                    <img src="images/KER5.jpg"             alt="Padmanabha"/>
                </div>
                <div class="slider-info">
                    <h3>Kerala Highlights</h3>
                    <p>From the tranquil backwaters of Alleppey to the lush tea gardens of Munnar, Kerala is nature's most beautiful canvas.</p>
                    <div class="highlights">
                        <span class="highlight-chip"><span class="fa fa-ship"></span> Alleppey</span>
                        <span class="highlight-chip"><span class="fa fa-tree"></span> Munnar</span>
                        <span class="highlight-chip"><span class="fa fa-umbrella"></span> Kovalam</span>
                        <span class="highlight-chip"><span class="fa fa-paw"></span> Wayanad</span>
                        <span class="highlight-chip"><span class="fa fa-institution"></span> Padmanabha</span>
                    </div>
                </div>
            </div>
            ...
            <div class="package-box">
                ...
                <?php
                /* Note: DB mein 'Kerela' spelling hai original code mein */
                $sqlhotel = "SELECT * FROM package WHERE pa_name='Kerela' OR pa_name='Kerala' LIMIT 1";
                ...
                <form action="predefine_book.php" method="post">
                    ...
                    <div class="package-footer">
                        <div class="price-block">
                            ...
                            <?php
                            $sql5  = "SELECT price FROM package WHERE pa_name='Kerela' OR pa_name='Kerala' LIMIT 1";
...
<script>
(function () {
    var video = document.getElementById('kerVideo');
