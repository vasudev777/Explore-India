...
<html lang="en">
<head>
    <title>Madhya Pradesh – Explore India</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Mobile: hide video, show gradient */
        .hero-fallback-bg {
            display: none;
            position: absolute;
            inset: 0;
            background: linear-gradient(160deg, #0a1e00 0%, #255900 50%, #3a8800 100%);
        }
        ...
        .hero-content h1 span { color: #7ed56f; }
        .hero-content p {
        ...
        .hero-scroll-btn {
            ...
            font-weight: 600;
            color: #fff;
            background: rgba(126,213,111,0.18);
            border: 1px solid rgba(126,213,111,0.4);
            padding: 10px 22px;
            border-radius: 30px;
            cursor: pointer;
        ...
        .hero-scroll-btn:hover {
            background: rgba(126,213,111,0.28);
            border-color: rgba(126,213,111,0.65);
            color: #fff;
            text-decoration: none;
        }
        ...
        .section-heading span { color: #7ed56f; }
        ...
        /* Custom 5-image Slider for Madhya Pradesh */
        .fling-minislide-5 {
            width: 100%;
            height: 260px;
            overflow: hidden;
        ...
        .itinerary-list {
            ...
            scrollbar-color: rgba(126,213,111,0.3) transparent;
        }
        .itinerary-list::-webkit-scrollbar { width: 4px; }
        .itinerary-list::-webkit-scrollbar-track { background: transparent; }
        .itinerary-list::-webkit-scrollbar-thumb { background: rgba(126,213,111,0.3); border-radius: 4px; }
        ...
        .itin-dot {
            ...
            border: 1.5px solid rgba(126,213,111,0.35);
            color: #7ed56f;
            font-size: 9.5px;
            font-weight: 700;
            display: flex;
        ...
        @media (max-width: 600px) {
            .video-hero .hero-video { display: block; }
            .hero-fallback-bg       { display: none; }
            .video-hero { height: 90vh; min-height: 380px; }
...
<div class="video-hero">
    ...
    <video
        ...
        playsinline
        >
        <source src="https://res.cloudinary.com/dkf2ala8d/video/upload/v1781768722/%E0%A4%9C%E0%A5%8B_%E0%A4%86%E0%A4%AF%E0%A4%BE_%E0%A4%B8%E0%A5%8B_%E0%A4%B5%E0%A4%BE%E0%A4%AA%E0%A4%B8_%E0%A4%86%E0%A4%AF%E0%A4%BE_%E0%A4%AF%E0%A5%87_%E0%A4%8F%E0%A4%AE%E0%A4%AA%E0%A5%80_%E0%A4%95%E0%A5%80_%E0%A4%AE%E0%A4%BE%E0%A4%AF%E0%A4%BE_-_New_TVC_of_MP___Madhya_Pradesh_Tourism_Ad_-_2023_1080p_avkd1t.mp4" type="video/mp4">
    </video>

    <div class="video-overlay"></div>

    <div class="hero-content">
        <div class="hero-badge">West India</div>
        <h1>Explore <span>Madhya Pradesh</span></h1>
        <p>Heart of India — ancient temples, tiger reserves, marble rocks and lush hill stations await you.</p>
...
<div class="main-content" id="package">
    <div class="content-wrapper">
        <p class="section-label">Madhya Pradesh Package</p>
        <h2 class="section-heading">Your Journey <span>Awaits</span></h2>

        <div class="two-col">

            <!-- LEFT: Image Slider + Info -->
            <div class="slider-box">
                <div class="fling-minislide-5">
                    <img src="images/MP1.jpg"      alt="Bandhavgarh"/>
                    <img src="images/MP2.jpg"      alt="khajuraho"/>
                    <img src="images/MP3.jpg" alt="pachmarhi"/>
                    <img src="images/MP4.jpg"    alt="marblerocks"/>
                    <img src="images/MP5.jpg"    alt="sanchistupa"/>
                </div>
                <div class="slider-info">
                    <h3>MP Highlights</h3>
                    <p>From the erotic sculptures of Khajuraho to the tiger trails of Bandhavgarh, Madhya Pradesh is a treasure trove of culture, wildlife and nature.</p>
                    <div class="highlights">
                        <span class="highlight-chip"><span class="fa fa-paw"></span> Bandhavgarh</span>
                        <span class="highlight-chip"><span class="fa fa-institution"></span> Khajuraho</span>
                        <span class="highlight-chip"><span class="fa fa-tree"></span> Pachmarhi</span>
                        <span class="highlight-chip"><span class="fa fa-tint"></span> Marble Rocks</span>
                        <span class="highlight-chip"><span class="fa fa-map-marker"></span> Sanchi Stupa</span>
                    </div>
                </div>
            </div>
            ...
            <div class="package-box">
                ...
                <?php
                $sqlhotel = "SELECT * FROM package WHERE pa_name='Madhya Pradesh' LIMIT 1";
                ...
                <form action="predefine_book.php" method="post">
                    ...
                    <div class="package-footer">
                        <div class="price-block">
                            ...
                            <?php
                            $sql5 = "SELECT price FROM package WHERE pa_name='Madhya Pradesh' LIMIT 1";
...
(function () {
    ...
    btn.addEventListener('click', function () {
        if (video.muted) {
            video.muted = false;
            video.volume = 1;
            // Browser ke liye play() call zaruri hai unmute ke baad
