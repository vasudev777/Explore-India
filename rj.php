...
<html lang="en">
<head>
    <title>Rajasthan – Explore India</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .hero-fallback-bg {
            ...
            position: absolute;
            inset: 0;
            background: linear-gradient(160deg, #321200 0%, #7a3500 50%, #c05800 100%);
        }
        .video-overlay {
            position: absolute;
            inset: 0;
        ...
        .section-heading span { color: #f5a623; }
        ...
        /* Custom 5-image Slider for Royal Rajasthan */
        .fling-minislide-5 {
            width: 100%;
            height: 260px;
            overflow: hidden;
        ...
        .itinerary-list::-webkit-scrollbar-thumb { background: rgba(245,166,35,0.3); border-radius: 4px; }
...
<div class="video-hero">
    ...
    <video
        ...
        playsinline
        >
        <source src="https://res.cloudinary.com/dkf2ala8d/video/upload/v1781771422/Huansthan_-_Rajasthan_Through_Huan_s_eyes_1080p_bydpbq.mp4" type="video/mp4">
    </video>
    ...
    <div class="hero-content">
        ...
        <h1>Explore <span>Rajasthan</span></h1>
        <p>Royal forts, golden sand dunes, camel trails and the magnificent Pink City of Jaipur.</p>
...
<div class="main-content" id="package">
    <div class="content-wrapper">
        <p class="section-label">Rajasthan Package</p>
        ...
        <div class="two-col">
            ...
            <div class="slider-box">
                <div class="fling-minislide-5">
                    <img src="images/RJ1.jpg" alt="Amberfort"/>
                    <img src="images/RJ2.jpg"   alt="lakepichola"/>
                    <img src="images/RJ3.jpg" alt="jaisalmer"/>
                    <img src="images/RJ4.jpg"  alt="mehrangarh"/>
                    <img src="images/RJ5.jpg"  alt="ranthambore"/>
                </div>
                <div class="slider-info">
                    <h3>Rajasthan Highlights</h3>
                    <p>From the lake palaces of Udaipur to the golden forts of Jaisalmer, Rajasthan is a land of royal grandeur, vibrant culture and endless desert horizons.</p>
                    <div class="highlights">
                        <span class="highlight-chip"><span class="fa fa-fort-awesome"></span> Amber Fort</span>
                        <span class="highlight-chip"><span class="fa fa-tint"></span> Lake Pichola</span>
                        <span class="highlight-chip"><span class="fa fa-sun-o"></span> Jaisalmer</span>
                        <span class="highlight-chip"><span class="fa fa-institution"></span> Mehrangarh</span>
                        <span class="highlight-chip"><span class="fa fa-paw"></span> Ranthambore</span>
                    </div>
                </div>
            </div>
            ...
            <div class="package-box">
                ...
                <?php
                $sqlhotel = "SELECT * FROM package WHERE pa_name='Rajasthan' LIMIT 1";
                ...
                <form action="predefine_book.php" method="post">
                    ...
                    <div class="package-footer">
                        <div class="price-block">
                            ...
                            <?php
                            $sql5  = "SELECT price FROM package WHERE pa_name='Rajasthan' LIMIT 1";
...
<script>
(function () {
    var video = document.getElementById('rjVideo');
    ...
    btn.addEventListener('click', function () {
        if (video.muted) {
            ...
            video.play().catch(function () {
                // Browser ne allow nahi kiya, wapas mute
                video.muted = true;
